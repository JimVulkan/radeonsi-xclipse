                                         ...
                                         struct si_shader_args *args)
{
   ...
   ac_build_attr_ring_descriptor(sel->screen->info.desc_gfx_level,
                                         ...
                                         struct si_shader_args *args)
{
   ...
   ac_build_raw_buffer_descriptor(screen->info.desc_gfx_level,
...
static bool build_gsvs_ring_desc(nir_builder *b, struct lower_abi_state *s)
{
   ...
   if (s->shader->is_gs_copy_shader) {
      ...
      for (unsigned stream = 0; stream < 4; stream++) {
         ...
         ac_build_buffer_descriptor(sel->screen->info.desc_gfx_level, &buffer_state, tmp_desc);
                                     ...
                                     bool payload)
{
   ...
   unsigned desc[4];
   ac_build_buffer_descriptor(screen->info.desc_gfx_level, &ac_state, desc);
