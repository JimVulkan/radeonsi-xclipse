...
This repository is a subset of Mesa 26.2.3 with changes by JimVulkan. Every file keeps the
...
zlib 1.3.1 (Zlib), both linked into the libraries, and Expat 2.5.0 (MIT), which is not.
The notices for everything compiled into the libraries are in `android/NOTICE.txt`, which
